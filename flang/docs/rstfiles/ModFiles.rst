...
#. The ``-module`` directory (Note: for gfortran the ``-J`` directory is not searched).
#. The current directory
#. The ``-I`` directories in the order they appear on the command line
...
determined the module is valid Fortran.\ :raw-html-m2r:`<br>`
